...
#  import tensorflow.compat.v1 as tf  # why compat.  function is not available
...
if __name__ == '__main__':
    ...
    df = pd.read_excel('C:/Users/yomay/Downloads/GA_model_previous/data_for_DNBmodel_nounknown.xlsx')  # this time use absolute address to input data
